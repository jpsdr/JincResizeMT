	...
	const float Val_Min[], const float Val_Max[])
{
	...
	const __m128 min_val = _mm_set_ps1(Val_Min[idxPlane]);
...
template void resize_plane_sse41<uint8_t>(const MT_Data_Info_JincResizeMT *MT_DataGF, const uint8_t idxPlane, const EWAPixelCoeff *coeff,
	const float Val_Min[], const float Val_Max[]);
template void resize_plane_sse41<uint16_t>(const MT_Data_Info_JincResizeMT *MT_DataGF, const uint8_t idxPlane, const EWAPixelCoeff *coeff,
	const float Val_Min[], const float Val_Max[]);
template void resize_plane_sse41<float>(const MT_Data_Info_JincResizeMT *MT_DataGF, const uint8_t idxPlane, const EWAPixelCoeff *coeff,
	const float Val_Min[], const float Val_Max[]);
